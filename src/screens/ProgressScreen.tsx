...
import { courseCategories, libraryBooks, type LibraryBook } from "../constants/data";
...
const ProgressScreen = () => {
  ...
  const progressBooks = useMemo<LibraryBook[]>(() => {
  ...
  const totalCourses = courseCategories.length;
          ...
          <View style={styles.bookList}>
            {progressBooks.map((book) => (
              <View key={book.id} style={styles.progressCard}>
                <Text style={styles.cardTitle}>{t(book.titleKey)}</Text>
                <Text style={styles.cardMeta}>{t(book.authorKey)}</Text>
